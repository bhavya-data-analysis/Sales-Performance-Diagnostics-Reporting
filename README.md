...
This project presents an end-to-end sales analytics solution built to move from analysis to action. It is structured into two complementary dashboards:
...
🔹 Project Overview
Organizations often have access to sales data but struggle to translate it into clear decisions. This project addresses that gap by separating analytics into two layers:
...
These features make the dashboards robust and production-oriented rather than demo-only.
🛠️ Tech Stack
Python
